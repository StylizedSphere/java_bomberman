...
public class ItemBreakWall extends Item {
    public ItemBreakWall(int x, int y, Board board) {
        super(x, y, Sprite.powerup_wallpass.getFxImage(), board);
    }

    public boolean collide(Entity entity) {
        if (entity instanceof Bomber) {
            if (!destroyed) board.breakWall = true;
            Sound.get_item();
        }
        destroyed = true;
        return false;
